...
spectrum1 = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_8.csv")
spectrum2 = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_85.csv")
spectrum3 = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_9.csv")
spectrum4 = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_95.csv")

spectrum1t = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_8_t.csv")
spectrum2t = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_85_t.csv")
spectrum3t = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_9_t.csv")
spectrum4t = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchspectrum_0_95_t.csv")

spectrum_fft = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchfft_spectrum.csv")
spectrum_fft_t = readdlm("./Applications/Kuramoto model/system with switch/results/results_kuramoto_switchfft_spectrum_t.csv")
