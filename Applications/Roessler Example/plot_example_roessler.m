...
subplot(339)
plot(1./fs1,10*log10(perio3), '.-', 'Linewidth', lw2)
grid on
title('Fourier powerspectrum of \tau-RR')
set(gca,'LineWidth',2)
set(gca,'Fontsize',fs)
...
set(gca,'LineWidth',2)
set(gca,'Fontsize',fs)
title('Trajectory of Rössler system \newline 5% add. noise (a = 0.36)')
...
subplot(331)
imagesc(RP_1_n), colormap([1 1 1 ; 0 0 0])
set(gca,'Ydir','normal')
set(gca,'LineWidth',2)
set(gca,'Fontsize',fs)
title('RP')
...
subplot(332)
imagesc(RP_2_n), colormap([1 1 1 ; 0 0 0])
set(gca,'Ydir','normal')
set(gca,'LineWidth',2)
set(gca,'Fontsize',fs)
title('RP')
...
subplot(333)
imagesc(RP_3_n), colormap([1 1 1 ; 0 0 0])
set(gca, 'YDir', 'normal')
set(gca,'LineWidth',2)
set(gca,'Fontsize',fs)
title('RP')
...
subplot(339)
plot(1./fs1_n,10*log10(perio3_n), '.-', 'Linewidth', lw2)
grid on
title('Fourier powerspectrum of \tau-RR')
set(gca,'LineWidth',2)
set(gca,'Fontsize',fs)
