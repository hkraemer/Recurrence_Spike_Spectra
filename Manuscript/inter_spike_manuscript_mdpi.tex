...
\begin{figure}
 ...
 Fig.~\ref{fig_power_grid_time_series} in Appendix~\ref{sec_power_grid_appendix}). 
 ...
 $15$, $30$ and $60$ \si{min}. For technical details on the calculation of the spectra shown, i.e preprocessing and window size being used, the reader is referred to the Appendix~\ref{sec_power_grid_appendix}.}  
\label{fig_power_grid_spectra}
\end{figure}

The evolutionary Fourier frequency spectrum for the Central Europe data in Figure~\ref{fig_power_grid_spectra}A, however, does not display sharp peaks exactly at $15$, $30$ and $60$ \si{min}, which may partly 
