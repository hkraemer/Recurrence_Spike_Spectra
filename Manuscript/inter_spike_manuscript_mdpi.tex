...
\item STLS and LASSO yield different results (qualitatively similar but not quantitatively). \todo[inline]{Add figure to the appendix explaining the search for the correct regularization}
...
\todo[inline]{Move stuff from Conclusion section into Discussion section}
