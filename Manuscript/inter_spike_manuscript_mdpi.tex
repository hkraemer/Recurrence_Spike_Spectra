...
sparse regression ``drags'' the $15$ \si{min} periods into the mentioned $30$ and $60$ \si{min} peaks.\todo[inline]{at Mehrnaz: please add more to the ``story''}.
...
$\Delta t_{\text{GB}}=1$\si{s}, respectively. \todo[inline]{to Mehrnaz: Please add the information which time these time series covered and maybe the source for the data} 
