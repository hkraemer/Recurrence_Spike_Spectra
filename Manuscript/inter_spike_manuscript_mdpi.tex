...
``generalized'', power spectral density. This is reasonable, since the average distances for a given lag $\tau$ 
\begin{equation}
...
power spectral density, i.e., Fourier transforming (FT) $\tau$-RR (Fig.~\ref{fig_tau_rr_spectrum_example}D,E), instead 
...
The general idea is that the sum of these weighted functions can approximate a finite signal to a sufficient degree. 
A number of decomposition techniques are out there based on different sets of basis functions, e.g., 
