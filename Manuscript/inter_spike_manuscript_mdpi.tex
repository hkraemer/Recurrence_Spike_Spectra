...
\begin{figure}
 ...
 which is highlighted in pink in \textbf{A}.\todo[inline]{MA: I think Fig.~\ref{fig_tau_rr_spectrum_example} should be restructured. We could talk about it.\\ HK: I will do that.}
...
\begin{figure}
 ...
 \caption{\todo[inline]{could you please become sure that A and B are not the same plots. They are super similar}.Averaged Fourier power spectra of recorded power grid frequency time series of \textbf{A} Central Europe (CE) and \textbf{B} Great Britain (GB) (see Appendix~\ref{sec_power_grid_appendix}). 
...
sparse regression ``drags'' the $15$ \si{min} periods into the mentioned $30$ and $60$ \si{min} peaks. Moreover, the inter spike spectra, unlike the Fourier spectra demonstrates sharp peaks exactly at $30$ and $60$ \si{min}, i.e. during dispatches. Eventually, here we have found a clear sharp peak at $40$ \si{min} which can occur because of any regular controls in a power grid, and can be a hint to develop the existing stochastic processes to model precisely the power grid frequency \cite{gorjao2020data}. 
...
\todo[inline]{Add this section and keep it very very short.}
