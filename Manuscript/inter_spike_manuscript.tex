...
regions) is continuously recorded and monitored by grid operators. For instance, in the case that there is more (less) demand than supply, the grid frequency decreases (increases) form nominal frequency \cite{kundur1994power}.
\\
...
{\color{red} Now we should start the story of Inter-spike-spectrum}.
