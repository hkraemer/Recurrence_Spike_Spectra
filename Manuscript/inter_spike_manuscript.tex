...
\subsection{Evolutionary spike spectrogram of Earth's orbit time series}

To demonstrate the usefulness of the proposed inter spike spectrum, we apply it to the freely available eccentricity time series of 
\citet{Laskar2011}. \todo[inline]{blabla what is this used for usually? etc.} We use a time series which covers the past \mytilde $67$ Mio. years, which a total length
of $N=13,421$ samples and a sampling period of $\Delta t= 5,000$. 
